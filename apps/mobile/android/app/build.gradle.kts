...
// trước khi build; máy dev không có file này thì rơi về ký bằng debug key như cũ.
...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.ltarc.mobile"
    ...
    buildTypes {
        release {
            // Có key.properties (CI hoặc dev đã tạo keystore riêng) → ký bằng release key thật.
            // Không có → rơi về debug key để `flutter run --release` cục bộ vẫn chạy được.
