...
@riverpod
Future<List<Employee>> employeeList(Ref ref) async {
  // GET /api/employees chỉ ADMIN/DIRECTOR/DEPARTMENT_HEAD gọi được ở backend
  // — trả rỗng sớm cho role khác (xem lý do ở userListProvider).
